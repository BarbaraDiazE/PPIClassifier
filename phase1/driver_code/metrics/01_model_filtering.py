"""Custom file to filter models by Q2 and Q3"""
import os
import pandas as pd
import numpy as np
...
def save_df(best_models_names, id_metrics, algorithm_name, quartile, root):
    ...
    output_root = f"{root}/results/metrics_results/filtered_results"
...
if __name__ == "__main__":
    ...
    """
    id_ is set manually according metrics
    ...
    for algorithm in algorithms:
        ModelFiltering(algorithm, "Q2").get_best_models(metrics, id)
        ModelFiltering(algorithm, "Q3").get_best_models(metrics, id)
