...
class ModelFiltering(GetReportValues):
    ...
    def get_best_models(self, metrics):
        ...
        best_models_names = [
            ...
            if
            # i in precision_bm and  #comment or uncomment to perform analysis
            i in balanced_accuracy_bm and
            # i in accuracy_bm
            # i in f1_bm and
            i in recall_bm
        ]
        print(
            ...
            "\n",
            "best models       : ",
            len(best_models_names),
            "\n",
            # "precision         : ", len(precision_bm), "\n",
            "balanced accuracy : ",
            len(balanced_accuracy_bm),
            "\n",
            # "accuracy          : ", len(accuracy_bm), "\n",
            # "f1                : ", len(f1_bm), "\n",
            "recall            : ",
            len(recall_bm),
            "\n",
...
if __name__ == "__main__":
    ...
    for algorithm in algorithms:
        filter_lrg = ModelFiltering(algorithm, "Q2")
        filter_lrg.get_best_models(metrics)
        filter_lrg = ModelFiltering(algorithm, "Q3")
        filter_lrg.get_best_models(metrics)


# TODO headmapas plots
