...
from phase1.support_functions.headmap_vars import bounds, colors
...
class PlotHeadmap:
    ...
    def plot(self):
        ...
        output_figure = f"headmap_{self.algorithm}_{self.quartile}.tiff"
        plt.savefig(
        ...
        plt.show()
        return f"{self.algorithm} headmap is ready"
...
if __name__ == "__main__":
    ...
    for algorithm_ in algorithms:
        p = PlotHeadmap(algorithm_, local_root, "Q2")
        p.plot()
    # Q3
    # for algorithm in algorithms:
    #     p = PlotHeadmap(algorithm, local_root, "Q3")
    #     p.plot()
